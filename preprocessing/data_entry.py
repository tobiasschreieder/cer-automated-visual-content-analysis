...
class WebPage:
    ...
    def load(cls, page_path: Path, image_id: str) -> 'WebPage':
        ...
        if cfg.data_image_format:
            ...
            path_main = cfg.data_dir.joinpath(Path('touche23-image-search-main'))
            ...
            snp_nodes = cfg.data_dir.joinpath('touche23-image-search-nodes/')\
                .joinpath(path_from_image).joinpath('snapshot/nodes.jsonl')
            snp_screenshot = cfg.data_dir.joinpath('touche23-image-search-screenshots/')\
            ...
            snp_archive = cfg.data_dir.joinpath('touche23-image-search-archives/')\
...
class DataEntry:
    ...
    def load(cls, image_id) -> 'DataEntry':
        ...
        if cfg.data_image_format:
            ...
            png = cfg.data_dir.joinpath(Path('touche23-image-search-png-images/'))\
        ...
        with path_main.joinpath(im_path).joinpath('image-vision.json').open(encoding="utf8") as file:
    ...
    def get_image_ids(max_size: int = -1) -> List[str]:
        ...
        if cfg.data_image_format:
            ...
            main_path = cfg.data_dir.joinpath(Path('touche23-image-search-main/images'))
